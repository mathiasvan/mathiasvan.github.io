			...
			(i = function () {
				...
				return (
					...
					Object.defineProperty(c, "context", {
						...
						set: function (t) {
							(e =
								c.Context && t instanceof c.Context
									? t
									: new c.Context(t)),
			...
			void 0 ===
				(o = function (t) {
					...
					return (
						...
						p5.soundOut._silentNode.connect(
							r.audiocontext.destination
						),
						r
					);
				...
				return (
					...
					(p5.Effect.prototype.dispose = function () {
						...
						r.soundArray.splice(t, 1),
							this.input &&
								(this.input.disconnect(), delete this.input),
							this.output &&
						...
						safeBufferSize: function (t) {
							var e = t,
								n = new AudioWorkletNode(
									u.audiocontext,
									i.soundFileProcessor
								);
							return (
								n instanceof ScriptProcessorNode &&
									(e = n.bufferSize),
								n.disconnect(),
								(n = null),
								e
			...
			void 0 ===
				(o = function (u) {
					...
					return (
						...
						(u.TimelineSignal.prototype.cancelScheduledValues = function (
							t
						) {
							return (
								(t = this.toSeconds(t)),
				...
				return (
					...
					(p5.Filter.prototype.dispose = function () {
						e.prototype.dispose.apply(this),
							this.biquad &&
								(this.biquad.disconnect(), delete this.biquad);
					}),
					(p5.LowPass = function () {
					...
					(p5.HighPass.prototype = Object.create(
						p5.Filter.prototype
					)),
					(p5.BandPass = function () {
						p5.Filter.call(this, "bandpass");
					}),
					(p5.BandPass.prototype = Object.create(
						p5.Filter.prototype
					)),
					p5.Filter
				);
			...
			void 0 ===
				(o = function (i) {
					...
					return (
						...
						(i.Param.prototype.exponentialRampToValueAtTime = function (
							t,
							e
						) {
							return (
		...
		void 0 ===
			(i = function (t) {
				...
				(p5.Oscillator = function (t, e) {
					...
					(p5.Oscillator.prototype.start = function (t, e) {
						...
						if (!this.started) {
							...
							this.oscillator.start(
								t + s.audiocontext.currentTime
							),
							(this.freqNode = this.oscillator.frequency),
							this._freqMods))
								void 0 !== this._freqMods[r].connect &&
									this._freqMods[r].connect(
					...
					(p5.Oscillator.prototype.fade =
						p5.Oscillator.prototype.amp),
					...
					return (
						...
						(e.Timeline.prototype._iterate = function (t, e, n) {
							...
							if (
								...
								for (
									var o = 0;
									o < this._toRemove.length;
									o++
								) {
									var r = this._timeline.indexOf(
										this._toRemove[o]
									);
				...
				(o = function (t) {
					...
					return (
						(t.GreaterThanZero = function () {
							(this._thresh = this.output = new t.WaveShaper(
								function (t) {
									return t <= 0 ? 0 : 1;
								},
								127
							)),
								(this._scale = this.input = new t.Multiply(
									1e4
								)),
		...
		void 0 ===
			(n = function (t) {
				...
				(p5.MonoSynth = function () {
					...
					(p5.MonoSynth.prototype = Object.create(
						p5.AudioVoice.prototype
					)),
				...
				(p5.PolySynth = function (t, e) {
					...
					(p5.PolySynth.prototype.noteAttack = function (t, e, n) {
						...
						if (
							...
							var a = p5.prototype.freqToMidi(
								this.audiovoices[this._oldest].oscillator.freq()
									.value
							);
							this.noteRelease(a),
								(this._oldest =
									(this._oldest + 1) % (this.maxVoices - 1));
						}
						(this.notes[r] = new h()),
							this.notes[r].setValueAtTime(i, o);
						var u =
						...
						if (
							...
							var p =
								(1 / this._voicesInUse.getValueAtTime(o)) * 2;
							s = p < s ? p : s;
						}
					...
					(p5.PolySynth.prototype.noteRelease = function (t, e) {
						...
						if (t) {
							...
							for (var a in (this.audiovoices.forEach(function (
								t
							) {
								t.triggerRelease(i);
							}),
			...
			(i = function () {
				...
				window,
					window.hasOwnProperty("webkitAudioContext") &&
						...
						((window.AudioContext = window.webkitAudioContext),
						"function" !=
							typeof AudioContext.prototype.createGain &&
							(AudioContext.prototype.createGain =
								AudioContext.prototype.createGainNode),
						"function" !=
							typeof AudioContext.prototype.createDelay &&
				...
				p5.prototype.isFileSupported = function (t) {
					switch (t.toLowerCase()) {
						case "mp3":
							return (
								!!e.canPlayType && e.canPlayType("audio/mpeg;")
							);
						case "wav":
							return (
								!!e.canPlayType &&
				...
				void 0 !== a.createStereoPanner
					...
					: ((p5.Panner = function (t, e, n) {
							(this.input = a.createGain()),
								...
								1 < n
									? ((this.splitter = a.createChannelSplitter(
											2
									  )),
		...
		void 0 ===
			(n = function (t) {
				...
				(p5.SoundFile = function (t, e, n, i) {
						...
						(this._clearOnEnd = function (t) {
							...
							(e._playing = !1),
								...
								n.bufferSourceNodes
									...
									.forEach(function (t) {
										!1 ===
											n.bufferSourceNodes[t]._playing &&
					...
					(p5.SoundFile.prototype.amp =
						p5.SoundFile.prototype.setVolume),
					(p5.SoundFile.prototype.fade =
						p5.SoundFile.prototype.setVolume),
			...
			(n = function (t) {
				...
				(p5.FFT = function (t, e) {
					...
					(p5.FFT.prototype.waveform = function () {
						...
						for (
							var i = new Array(), o = 0;
							o < this.timeDomain.length;
							o++
						) {
							var r = p5.prototype.map(
								this.timeDomain[o],
								0,
								255,
								-1,
					...
					(p5.FFT.prototype.getCentroid = function () {
						for (
							var t = c.audiocontext.sampleRate / 2,
								e = 0,
								n = 0,
								i = 0;
						...
						return (
							0 !== n && (o = e / n),
							o * (t / this.freqDomain.length)
						);
					}),
					(p5.FFT.prototype.smooth = function (t) {
						return (
							void 0 !== t && (this.smoothing = t), this.smoothing
						);
					}),
					...
					(p5.FFT.prototype.logAverages = function (t) {
						for (
							...
							Math.round((s * e) / this.freqDomain.length) >
								t[r].hi && r++,
								(o[r] =
									void 0 !== o[r] ? (o[r] + n[s]) / 2 : n[s]);
						}
						return o;
					}),
					(p5.FFT.prototype.getOctaveBands = function (t, e) {
						...
						n.push(i);
						for (
							var o = c.audiocontext.sampleRate / 2;
							i.hi < o;
			...
			void 0 ===
				(o = function (o) {
					(o.Frequency = function (t, e) {
							...
							return (
								(this._expr = function (t, e) {
									for (
										...
										i[o] =
											n *
											this.intervalToFrequencyRatio(e[o]);
									return i;
								}.bind(this, this._expr, t)),
								this
							);
						...
						(o.Frequency.prototype._frequencyToUnits = function (
							t
						) {
							return t;
						}),
						...
						(o.Frequency.prototype._beatsToUnits = function (t) {
							return (
								1 /
								o.TimeBase.prototype._beatsToUnits.call(this, t)
							);
						}),
					...
					return (
						...
						(o.Frequency.prototype.frequencyToMidi = function (t) {
							return (
								69 +
								(12 * Math.log(t / o.Frequency.A4)) / Math.LN2
							);
						}),
						o.Frequency
					);
		...
		void 0 ===
			(i = function (t) {
				...
				(p5.Envelope = function (t, e, n, i, o, r) {
					...
					(p5.Envelope.prototype.setRampPercentages = function (
						t,
						e
					) {
					...
					(p5.Envelope.prototype.ramp = function (t, e, n, i) {
						...
						t && this.connection !== t && this.connect(t);
						var a = this.checkExpInput(
							this.control.getValueAtTime(o)
						);
						a < r
		...
		void 0 ===
			(i = function (t) {
				...
				n(23),
					...
					(p5.Pulse.prototype = Object.create(
						p5.Oscillator.prototype
					)),
					(p5.Pulse.prototype.width = function (t) {
						if ("number" == typeof t) {
							if (t <= 1 && 0 <= t) {
								this.w = t;
								var e =
									this.w / this.oscillator.frequency.value;
		...
		void 0 ===
			(n = function (t) {
				...
				(p5.Noise = function (t) {
					...
					(p5.Noise.prototype = Object.create(
						p5.Oscillator.prototype
					));
				var n = (function () {
						for (
						...
						r.inputSources[this.currentSource] &&
							...
							window.navigator.mediaDevices
								...
								.then(function (t) {
									(i.stream = t),
										(i.enabled = !0),
										(i.mediaStream = r.audiocontext.createMediaStreamSource(
											t
										)),
				...
				(o = function (e) {
					...
					return (
						(e.GreaterThan = function (t) {
							this.createInsOuts(2, 0),
								(this._param = this.input[0] = new e.Subtract(
									t
								)),
			...
			(i = function (t) {
				...
				return (
					...
					(p5.Panner3D.dispose = function () {
						e.prototype.dispose.apply(this),
							this.panner &&
								(this.panner.disconnect(), delete this.panner);
					}),
					p5.Panner3D
				);
			}.call(e, n, e, t)) || (t.exports = i);
			...
			(n = function (t) {
				...
				(p5.Delay = function () {
					n.call(this),
						...
						this._leftFilter.biquad.Q.setValueAtTime(
							0.3,
							this.ac.currentTime
						),
						this._rightFilter.biquad.Q.setValueAtTime(
							0.3,
							this.ac.currentTime
						),
						...
						this._leftFilter.biquad.gain.setValueAtTime(
							1,
							this.ac.currentTime
						),
		...
		void 0 ===
			(i = function (t) {
				...
				(p5.Reverb = function () {
					...
					(p5.Convolver.prototype = Object.create(
						p5.Reverb.prototype
					)),
					p5.prototype.registerPreloadMethod(
						"createConvolver",
